...
export async function POST(request: Request) {
  ...
  const content = `Je te donne cette liste de catégories : ${body.categories.map((value: string) => value)}.
          ...
          et noter cette catégorie. Je veux que tu me retourne le résultat sous forme d'un objet JSON,  avec deux clefs, la première nommé 'resultat', qui est un objet,
          ...
          La deuxième clef est 'avis', qui est un resume de l'analyse que tu as faite pour chaque categories en fonction des messages. 
